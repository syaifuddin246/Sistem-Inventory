...
@section('title', 'Laporan Penjualan Hijab')
@section('content')
    <div class="container">
        <div class="row justify-content-center pt-4" style="padding-bottom: 90px;">
            <div class="col-md-12">
                <h5 class="text-center pb-4">Laporan Penjualan Hijab</h5>
                <div class="card" style="padding: 10px;">
                    ...
                    <table id="example1" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($laporanpenjualan as $key => $row)
                            <tr>
                                <td>{{ $laporanpenjualan->firstItem() + $key }}</td>
